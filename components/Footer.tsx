      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 text-sm text-dark-400">
            ...
            <a href="/examples" className="hover:text-white transition-colors">Exemplos</a>
            <a href="https://github.com/dev-erickydias/github-api" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>

        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative">
          <ScrollReveal>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Pronto para <span className="gradient-text">comecar</span>?
            </h2>
            <p className="text-dark-300 mb-8 max-w-lg mx-auto">
              Teste a API agora mesmo no playground interativo ou leia a documentacao completa para integrar nos seus projetos.
            </p>
          ...
          <ScrollReveal>
            <div className="glass-card rounded-2xl p-8 text-center">
              <p className="text-dark-300 mb-4">
                Tem duvidas, sugestoes ou quer colaborar?
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  ...
                  className="btn-primary !bg-[#0A66C2] text-sm inline-flex items-center gap-2 hover:!shadow-[#0A66C2]/30"
                >
